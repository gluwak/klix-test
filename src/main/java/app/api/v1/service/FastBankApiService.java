...
@Service
public class FastBankApiService {
    ...
    public FastBankApiService(@Qualifier("fast-bank-rest-template") RestTemplate restTemplate, ObjectMapper objectMapper) {
        this.restTemplate = restTemplate;
        this.objectMapper = objectMapper;
    }

    public CreateApplicationResponse sendApplication(FastBankCreateApplicationRequest request) {
